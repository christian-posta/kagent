...
type AsyncBackend interface {
	...
	// have no post-ready work should return nil. Merged into AsyncBackend
	// to match pj-kagent's shape — both our openshell and the lifted
	// substrate harness backend implement it.
